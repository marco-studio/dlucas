      ...
      <div>
        ...
        <div className="text-center p-8 max-w-md md:max-w-lg m-auto mt-16 lg:max-w-xl lgx:max-w-2xl lgx:mt-24">
          ...
          <div className="mt-3 text-gray-700 leading-relaxed md:text-xl">
            Taking a different approach to the Barber industry, Dlucs has built
            his following and business through social media, and the belief of
            staying authentic throughout the whole process, no matter how
            unfiltered he gets. Taking a dive into the barber industry and his
            views on social media, business, personal growth, and how you can be
